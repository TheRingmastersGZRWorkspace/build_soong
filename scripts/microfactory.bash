...
function soong_build_go
{
    BUILDDIR=$(getoutdir) \
      ...
      EXTRA_ARGS="-pkg-path android/soong=${TOP}/build/soong -pkg-path github.com/golang/protobuf=${TOP}/external/golang-protobuf -pkg-path validus/soong=${TOP}/vendor/validus/build/soong" \
      build_go $@
}
